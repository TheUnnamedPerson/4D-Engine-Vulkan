...
{
    std::cout << vertices[0].pos.x << " " << vertices[0].pos.y << " " << std::endl;
    std::cout << vertices[1].pos.x << " " << vertices[1].pos.y << " " << std::endl;
    std::cout << vertices[2].pos.x << " " << vertices[2].pos.y << " " << std::endl;
